...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="md:lg:flex lg:w-[52%] flex-col justify-between p-8 relative overflow-hidden rounded-b-xl md:rounded-r-xl"
        ...
        <div className="relative z-10 space-y-10">
          <div className="space-y-4">
            <h1 className="text-white font-display md:text-5xl text-3xl font-bold leading-tight text-balance">
              Vos cours et examens<br />
              <span className="text-white font-display text-2xl font-bold leading-tight text-balance" style={{ color: '#a5b4fc' }}>toujours accessibles.</span>
            </h1>
            <p className="text-indigo-200 text-lg leading-relaxed max-w-md ml-10">
          ...
          <div className="space-y-4">
            {[
              { icon: BookOpen,      label: 'Cours et Anciens sujets',     desc: 'Accessible a tous les etudiants de la faculte des sciences' },
              { icon: FileText,      label: 'Comment faire pour avoir acces ? ',        desc: 'Etre etudiant de la faculte des sciences et dispose d´un matricule' },
              { icon: GraduationCap, label: 'Support technique ',     desc: ' wahsapp +237655595984' },
        ...
        <p className="relative z-10 text-indigo-400 text-sm mt-5">
          © {new Date().getFullYear()} fs-archive — faculte des sciences universite de garoua
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">
                Étudiant : 22FSxxxx · Enseignant : ENS-xxxx · Admin : ADM-xxxx
              </p>
            </div>
